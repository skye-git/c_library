...
#define MAVLINK_MSG_ID_LED_CONTROL 220
...
#define MAVLINK_MSG_ID_LED_CONTROL_MIN_LEN 9
#define MAVLINK_MSG_ID_220_LEN 9
#define MAVLINK_MSG_ID_220_MIN_LEN 9
 ...
 * @param mode Compare LED_CONTROL_MODE enumerator - 0: Constant light, 1: Blink on/off, 2: Pulsate, 3: Colorloop, 4: Disco, 5: power, 6: speed, 7: rotation
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_led_control_send(chan, led_control->led_id, led_control->red, led_control->green, led_control->blue, led_control->mode, led_control->frequency);
#else
 ...
 */
static inline void mavlink_msg_led_control_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t led_id, uint8_t red, uint8_t green, uint8_t blue, uint8_t mode, float frequency)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 *
 * @return Compare LED_CONTROL_MODE enumerator - 0: Constant light, 1: Blink on/off, 2: Pulsate, 3: Colorloop, 4: Disco, 5: power, 6: speed, 7: rotation
 */
