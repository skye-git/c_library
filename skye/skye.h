...
#include "./mavlink_msg_position_ctrl_output_raw.h"
#include "./mavlink_msg_attitude_ctrl_output_raw.h"
#include "./mavlink_msg_allocation_output_raw.h"
