...
#ifndef HAVE_ENUM_2DOF_UNIT
#define HAVE_ENUM_2DOF_UNIT
typedef enum 2DOF_UNIT
{
	2DOF_UNIT_PWM=0, /* Input is given as PWM value. General ranging between 0 and 1000. | */
	2DOF_UNIT_NEWTON=1, /* Input is given in Newton. | */
	2DOF_UNIT_ENUM_END=2, /*  | */
} 2DOF_UNIT;
#endif
