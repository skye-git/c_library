...
typedef enum MAV_CMD
{
	...
	MAV_CMD_SET_RGB_LED=5000, /* Change RGB LED Behavior. |Operation, as defined by ENUM RGBLED_OPERATIONS| Reserved for args.| Reserved for args.| Reserved for args.|  */
