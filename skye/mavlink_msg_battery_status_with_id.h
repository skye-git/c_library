...
#define MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_LEN 38
#define MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_MIN_LEN 38
#define MAVLINK_MSG_ID_217_LEN 38
#define MAVLINK_MSG_ID_217_MIN_LEN 38

#define MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_CRC 221
#define MAVLINK_MSG_ID_217_CRC 221
...
#define MAVLINK_MESSAGE_INFO_BATTERY_STATUS_WITH_ID { \
	...
	{  { "current_consumed", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_battery_status_with_id_t, current_consumed) }, \
         ...
         { "id", NULL, MAVLINK_TYPE_UINT8_T, 0, 34, offsetof(mavlink_battery_status_with_id_t, id) }, \
         { "n_cells", NULL, MAVLINK_TYPE_INT8_T, 0, 35, offsetof(mavlink_battery_status_with_id_t, n_cells) }, \
         { "battery_state", NULL, MAVLINK_TYPE_UINT8_T, 0, 36, offsetof(mavlink_battery_status_with_id_t, battery_state) }, \
         { "battery_remaining", NULL, MAVLINK_TYPE_INT8_T, 0, 37, offsetof(mavlink_battery_status_with_id_t, battery_remaining) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_BATTERY_STATUS_WITH_ID { \
...
static inline uint16_t mavlink_msg_battery_status_with_id_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint8_t id, int32_t current_consumed, int32_t energy_consumed, int32_t current_charged, uint32_t time_charged, int16_t temperature, uint16_t voltage, const uint16_t *cell_voltages, int8_t n_cells, int16_t current_battery, uint8_t battery_state, int8_t battery_remaining)
{
	...
	_mav_put_int8_t(buf, 35, n_cells);
	_mav_put_uint8_t(buf, 36, battery_state);
	_mav_put_int8_t(buf, 37, battery_remaining);
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_MIN_LEN, MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_LEN, MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_CRC);
}
						           ...
						           uint8_t id,int32_t current_consumed,int32_t energy_consumed,int32_t current_charged,uint32_t time_charged,int16_t temperature,uint16_t voltage,const uint16_t *cell_voltages,int8_t n_cells,int16_t current_battery,uint8_t battery_state,int8_t battery_remaining)
{
	...
	msg->msgid = MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_MIN_LEN, MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_LEN, MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_CRC);
}
...
{
	return mavlink_msg_battery_status_with_id_pack_chan(system_id, component_id, chan, msg, battery_status_with_id->id, battery_status_with_id->current_consumed, battery_status_with_id->energy_consumed, battery_status_with_id->current_charged, battery_status_with_id->time_charged, battery_status_with_id->temperature, battery_status_with_id->voltage, battery_status_with_id->cell_voltages, battery_status_with_id->n_cells, battery_status_with_id->current_battery, battery_status_with_id->battery_state, battery_status_with_id->battery_remaining);
}
...
static inline void mavlink_msg_battery_status_with_id_send(mavlink_channel_t chan, uint8_t id, int32_t current_consumed, int32_t energy_consumed, int32_t current_charged, uint32_t time_charged, int16_t temperature, uint16_t voltage, const uint16_t *cell_voltages, int8_t n_cells, int16_t current_battery, uint8_t battery_state, int8_t battery_remaining)
{
	...
	_mav_put_int8_t(buf, 37, battery_remaining);
	_mav_put_uint16_t_array(buf, 20, cell_voltages, 6);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID, buf, MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_MIN_LEN, MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_LEN, MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_CRC);
#else
	mavlink_battery_status_with_id_t packet;
	packet.current_consumed = current_consumed;
	packet.energy_consumed = energy_consumed;
	...
	packet.battery_remaining = battery_remaining;
	mav_array_memcpy(packet.cell_voltages, cell_voltages, sizeof(uint16_t)*6);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID, (const char *)&packet, MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_MIN_LEN, MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_LEN, MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_battery_status_with_id_send_struct(mavlink_channel_t chan, const mavlink_battery_status_with_id_t* battery_status_with_id)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_battery_status_with_id_send(chan, battery_status_with_id->id, battery_status_with_id->current_consumed, battery_status_with_id->energy_consumed, battery_status_with_id->current_charged, battery_status_with_id->time_charged, battery_status_with_id->temperature, battery_status_with_id->voltage, battery_status_with_id->cell_voltages, battery_status_with_id->n_cells, battery_status_with_id->current_battery, battery_status_with_id->battery_state, battery_status_with_id->battery_remaining);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID, (const char *)battery_status_with_id, MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_MIN_LEN, MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_LEN, MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_CRC);
#endif
}
...
/**
 * @brief Get field id from battery_status_with_id message
 *
 * @return Au ID
 */
static inline uint8_t mavlink_msg_battery_status_with_id_get_id(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_battery_status_with_id_decode(const mavlink_message_t* msg, mavlink_battery_status_with_id_t* battery_status_with_id)
{
	...
	battery_status_with_id->id = mavlink_msg_battery_status_with_id_get_id(msg);
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_LEN? msg->len : MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_LEN;
        memset(battery_status_with_id, 0, MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_LEN);
	memcpy(battery_status_with_id, _MAV_PAYLOAD(msg), len);
#endif
}
