...
static void mavlink_test_actuator_limits(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_ACTUATOR_LIMITS >= 256) {
        	return;
        }
#endif
	...
	mavlink_actuator_limits_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           ...
           memset(MAVLINK_MSG_ID_ACTUATOR_LIMITS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_ACTUATOR_LIMITS_MIN_LEN);
        }
#endif
...
static void mavlink_test_actuation_configuration(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_ACTUATION_CONFIGURATION >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
	...
	mavlink_actuation_configuration_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_ACTUATION_CONFIGURATION_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_ACTUATION_CONFIGURATION_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_actuation_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_ACTUATION_STATUS >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
	...
	mavlink_actuation_status_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_ACTUATION_STATUS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_ACTUATION_STATUS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_allocation_output(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_ALLOCATION_OUTPUT >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
	...
	mavlink_allocation_output_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_ALLOCATION_OUTPUT_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_ALLOCATION_OUTPUT_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_actuation_feedback(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_ACTUATION_FEEDBACK >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
	...
	mavlink_actuation_feedback_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_ACTUATION_FEEDBACK_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_ACTUATION_FEEDBACK_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_skye_feedback_combined(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SKYE_FEEDBACK_COMBINED >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
	...
	mavlink_skye_feedback_combined_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SKYE_FEEDBACK_COMBINED_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SKYE_FEEDBACK_COMBINED_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_range_sensor_raw(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_RANGE_SENSOR_RAW >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
	...
	mavlink_range_sensor_raw_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_RANGE_SENSOR_RAW_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_RANGE_SENSOR_RAW_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_allocation_sensor(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_ALLOCATION_SENSOR >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
	...
	mavlink_allocation_sensor_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_ALLOCATION_SENSOR_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_ALLOCATION_SENSOR_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_battery_status_with_id(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_battery_status_with_id_t packet_in = {
		963497464,963497672,963497880,963498088,18067,18171,{ 18275, 18276, 18277, 18278, 18279, 18280 },18899,235,46,113,180
    };
	mavlink_battery_status_with_id_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.current_consumed = packet_in.current_consumed;
        packet1.energy_consumed = packet_in.energy_consumed;
        packet1.current_charged = packet_in.current_charged;
        packet1.time_charged = packet_in.time_charged;
        packet1.temperature = packet_in.temperature;
        packet1.voltage = packet_in.voltage;
        packet1.current_battery = packet_in.current_battery;
        packet1.id = packet_in.id;
        packet1.n_cells = packet_in.n_cells;
        packet1.battery_state = packet_in.battery_state;
        packet1.battery_remaining = packet_in.battery_remaining;
        
        mav_array_memcpy(packet1.cell_voltages, packet_in.cell_voltages, sizeof(uint16_t)*6);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_BATTERY_STATUS_WITH_ID_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_battery_status_with_id_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_battery_status_with_id_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_battery_status_with_id_pack(system_id, component_id, &msg , packet1.id , packet1.current_consumed , packet1.energy_consumed , packet1.current_charged , packet1.time_charged , packet1.temperature , packet1.voltage , packet1.cell_voltages , packet1.n_cells , packet1.current_battery , packet1.battery_state , packet1.battery_remaining );
	mavlink_msg_battery_status_with_id_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_battery_status_with_id_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.id , packet1.current_consumed , packet1.energy_consumed , packet1.current_charged , packet1.time_charged , packet1.temperature , packet1.voltage , packet1.cell_voltages , packet1.n_cells , packet1.current_battery , packet1.battery_state , packet1.battery_remaining );
	mavlink_msg_battery_status_with_id_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_battery_status_with_id_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_battery_status_with_id_send(MAVLINK_COMM_1 , packet1.id , packet1.current_consumed , packet1.energy_consumed , packet1.current_charged , packet1.time_charged , packet1.temperature , packet1.voltage , packet1.cell_voltages , packet1.n_cells , packet1.current_battery , packet1.battery_state , packet1.battery_remaining );
	mavlink_msg_battery_status_with_id_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_setpoint_12dof(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SETPOINT_12DOF >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
	...
	mavlink_setpoint_12dof_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SETPOINT_12DOF_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SETPOINT_12DOF_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_skye_attitude_hil(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SKYE_ATTITUDE_HIL >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
	...
	mavlink_skye_attitude_hil_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SKYE_ATTITUDE_HIL_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SKYE_ATTITUDE_HIL_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_skye_position_hil(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SKYE_POSITION_HIL >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
	...
	mavlink_skye_position_hil_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SKYE_POSITION_HIL_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SKYE_POSITION_HIL_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_skye_debug_vec3(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SKYE_DEBUG_VEC3 >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
	...
	mavlink_skye_debug_vec3_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SKYE_DEBUG_VEC3_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SKYE_DEBUG_VEC3_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_skye(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_battery_status_with_id(system_id, component_id, last_msg);
