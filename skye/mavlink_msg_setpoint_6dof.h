...
typedef struct MAVLINK_PACKED __mavlink_setpoint_6dof_t
{
...
#define MAVLINK_MSG_ID_SETPOINT_6DOF_MIN_LEN 25
#define MAVLINK_MSG_ID_221_LEN 25
#define MAVLINK_MSG_ID_221_MIN_LEN 25

#define MAVLINK_MSG_ID_SETPOINT_6DOF_CRC 15
#define MAVLINK_MSG_ID_221_CRC 15
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_setpoint_6dof_send(chan, setpoint_6dof->target_system, setpoint_6dof->trans_x, setpoint_6dof->trans_y, setpoint_6dof->trans_z, setpoint_6dof->rot_x, setpoint_6dof->rot_y, setpoint_6dof->rot_z);
#else
