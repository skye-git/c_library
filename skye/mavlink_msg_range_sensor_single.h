...
#define MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE 218
...
#define MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_MIN_LEN 22
#define MAVLINK_MSG_ID_218_LEN 22
#define MAVLINK_MSG_ID_218_MIN_LEN 22

#define MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_CRC 117
#define MAVLINK_MSG_ID_218_CRC 117
						       ...
						       uint64_t px4_ts, uint32_t pozyx_ts, uint32_t range, int16_t rssi, uint16_t anchor_id, uint16_t tag_id)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_MIN_LEN, MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_LEN, MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_CRC);
}
						           ...
						           uint64_t px4_ts,uint32_t pozyx_ts,uint32_t range,int16_t rssi,uint16_t anchor_id,uint16_t tag_id)
{
	...
	msg->msgid = MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_MIN_LEN, MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_LEN, MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_CRC);
}
...
static inline void mavlink_msg_range_sensor_single_send(mavlink_channel_t chan, uint64_t px4_ts, uint32_t pozyx_ts, uint32_t range, int16_t rssi, uint16_t anchor_id, uint16_t tag_id)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE, buf, MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_MIN_LEN, MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_LEN, MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_CRC);
#else
	mavlink_range_sensor_single_t packet;
	packet.px4_ts = px4_ts;
	packet.pozyx_ts = pozyx_ts;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE, (const char *)&packet, MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_MIN_LEN, MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_LEN, MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_range_sensor_single_send_struct(mavlink_channel_t chan, const mavlink_range_sensor_single_t* range_sensor_single)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_range_sensor_single_send(chan, range_sensor_single->px4_ts, range_sensor_single->pozyx_ts, range_sensor_single->range, range_sensor_single->rssi, range_sensor_single->anchor_id, range_sensor_single->tag_id);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE, (const char *)range_sensor_single, MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_MIN_LEN, MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_LEN, MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_LEN? msg->len : MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_LEN;
        memset(range_sensor_single, 0, MAVLINK_MSG_ID_RANGE_SENSOR_SINGLE_LEN);
	memcpy(range_sensor_single, _MAV_PAYLOAD(msg), len);
#endif
}
