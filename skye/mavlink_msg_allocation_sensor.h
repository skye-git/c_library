						       ...
						       const float *angle, const float *thrust, const float *angle_valid, const float *thrust_valid)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ALLOCATION_SENSOR_LEN, MAVLINK_MSG_ID_ALLOCATION_SENSOR_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ALLOCATION_SENSOR_LEN);
#endif
}
						           ...
						           const float *angle,const float *thrust,const float *angle_valid,const float *thrust_valid)
{
	...
	msg->msgid = MAVLINK_MSG_ID_ALLOCATION_SENSOR;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ALLOCATION_SENSOR_LEN, MAVLINK_MSG_ID_ALLOCATION_SENSOR_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ALLOCATION_SENSOR_LEN);
#endif
}
...
static inline void mavlink_msg_allocation_sensor_send(mavlink_channel_t chan, const float *angle, const float *thrust, const float *angle_valid, const float *thrust_valid)
{
	...
	_mav_put_float_array(buf, 72, thrust_valid, 6);
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ALLOCATION_SENSOR, buf, MAVLINK_MSG_ID_ALLOCATION_SENSOR_LEN, MAVLINK_MSG_ID_ALLOCATION_SENSOR_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ALLOCATION_SENSOR, buf, MAVLINK_MSG_ID_ALLOCATION_SENSOR_LEN);
#endif
#else
	mavlink_allocation_sensor_t packet;
	...
	mav_array_memcpy(packet.thrust_valid, thrust_valid, sizeof(float)*6);
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ALLOCATION_SENSOR, (const char *)&packet, MAVLINK_MSG_ID_ALLOCATION_SENSOR_LEN, MAVLINK_MSG_ID_ALLOCATION_SENSOR_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ALLOCATION_SENSOR, (const char *)&packet, MAVLINK_MSG_ID_ALLOCATION_SENSOR_LEN);
#endif
#endif
}
...
#else
	memcpy(allocation_sensor, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_ALLOCATION_SENSOR_LEN);
#endif
}
