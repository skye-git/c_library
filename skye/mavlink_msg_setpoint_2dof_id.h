...
#define MAVLINK_MSG_ID_SETPOINT_2DOF_ID_LEN 9
#define MAVLINK_MSG_ID_SETPOINT_2DOF_ID_MIN_LEN 9
#define MAVLINK_MSG_ID_222_LEN 9
#define MAVLINK_MSG_ID_222_MIN_LEN 9

#define MAVLINK_MSG_ID_SETPOINT_2DOF_ID_CRC 101
#define MAVLINK_MSG_ID_222_CRC 101
...
{
	return mavlink_msg_setpoint_2dof_id_pack(system_id, component_id, msg, setpoint_2dof_id->id, setpoint_2dof_id->angle, setpoint_2dof_id->thrust);
}
...
{
	return mavlink_msg_setpoint_2dof_id_pack_chan(system_id, component_id, chan, msg, setpoint_2dof_id->id, setpoint_2dof_id->angle, setpoint_2dof_id->thrust);
}
...
static inline void mavlink_msg_setpoint_2dof_id_send(mavlink_channel_t chan, uint8_t id, float angle, float thrust)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_SETPOINT_2DOF_ID_LEN];
	_mav_put_float(buf, 0, angle);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_setpoint_2dof_id_send(chan, setpoint_2dof_id->id, setpoint_2dof_id->angle, setpoint_2dof_id->thrust);
#else
 ...
 */
static inline void mavlink_msg_setpoint_2dof_id_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t id, float angle, float thrust)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
